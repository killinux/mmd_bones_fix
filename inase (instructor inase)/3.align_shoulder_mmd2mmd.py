...
target_armature_name = "Inase_arm"
...
align_bone_heads(source_armature_name, "肩P.L", target_armature_name, "肩.L")
align_bone_heads(source_armature_name, "肩C.L", target_armature_name, "腕.L")
align_bone_heads(source_armature_name, "肩P.R", target_armature_name, "肩.R")
align_bone_heads(source_armature_name, "肩C.R", target_armature_name, "腕.R")
