...
#    "glistening grace hat",
    ...
    "head hair front left 4",

    "head hair ponytail right 2a",
    "head hair ponytail right 2b",
    "head hair ponytail right 2c",
    "head hair ponytail right 2d",
    "head hair ponytail right 2e",
    "head hair ponytail right 2f",
    "head hair ponytail left 2a",
    "head hair ponytail left 2b",
    "head hair ponytail left 2c",
    "head hair ponytail left 2d",
    "head hair ponytail left 2e",
    "head hair ponytail left 2f",
    
    "head hair ponytail right 1a",
    "head hair ponytail right 1b",
    "head hair ponytail right 1c",
    "head hair ponytail right 1d",
    "head hair ponytail right 1e",
    "head hair ponytail right 1f",
    "head hair ponytail right 1g",
    "head hair ponytail right 1h",
    
    "head hair ponytail left 1a",
    "head hair ponytail left 1b",
    "head hair ponytail left 1c",
    "head hair ponytail left 1d",
    "head hair ponytail left 1e",
    "head hair ponytail left 1f",
    "head hair ponytail left 1g",
    "head hair ponytail left 1h",
